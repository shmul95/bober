...
# -----------------------------
# 6) Main loop: save raw, inference + raycasts
# -----------------------------
with dai.Device(pipeline, maxUsbSpeed=dai.UsbSpeed.HIGH) as device:
    ...
    while True:
        ...
        raw_path = os.path.join(OUT_DIR, "raw_frame.png")
